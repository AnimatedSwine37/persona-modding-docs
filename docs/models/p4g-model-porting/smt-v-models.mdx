...
![](/assets/images/models/smt-v-models/actor%20x.png)

![](/assets/images/models/smt-v-models/lod%20info.png)                    
...
![](/assets/images/models/smt-v-models/root%20bone.png)

Next, move up to the top and right-click the rotate option.

![](/assets/images/models/smt-v-models/rotate%20option.png)
...
![](/assets/images/models/smt-v-models/viewport%20view.png)
...
![](/assets/images/models/smt-v-models/skin%20option.png)

![](/assets/images/models/smt-v-models/skin%20option%202.png)

Next, open up the drop-down of the Editable Mesh and select the term “Element.”

![](/assets/images/models/smt-v-models/element%20selected.png)
...
![](/assets/images/models/smt-v-models/mesh%20split%20wings.png)
...
![](/assets/images/models/smt-v-models/detach%20split%20mesh.png)
...
![](/assets/images/models/smt-v-models/leftover%20bit.png)*Leftover bits will be highlighted in red, as shown here.*
...
![](/assets/images/models/smt-v-models/viewport%20view%20again.png)                                                                 
...
![](/assets/images/models/smt-v-models/material%20editor.png)

A new window will pop up, move to the top left and select the “Picker” option shown here:

![](/assets/images/models/smt-v-models/picker%20option.png)
...
![](/assets/images/models/smt-v-models/material%20trees.png)

Double-click on each texture option, and select the option labeled bitmap.

![](/assets/images/models/smt-v-models/select%20bitmap%20texture.png)
...
![](/assets/images/models/smt-v-models/applied%20textures.png)
...
![](/assets/images/models/smt-v-models/incorrect%20material.png)

This is:

![](/assets/images/models/smt-v-models/correct%20material.png)
...
![](/assets/images/models/smt-v-models/export%20options.png)
...
![](/assets/images/models/smt-v-models/import%20psa.png)
...
![](/assets/images/models/smt-v-models/model%20viewport%20psa.png)

![](/assets/images/models/smt-v-models/correct%20viewport%20psa.png)
...
![](/assets/images/models/smt-v-models/shown%20command.png)
...
![](/assets/images/models/smt-v-models/correct%20animation%20view.png)
...
* **First**, change the extension of your textures to .tm2 in the texture location at the bottom.
    ![](/assets/images/models/smt-v-models/changed%20texture%20extension.png)
* **Second**, fix the materials by copying the material data from a working P4G model. If you don’t do this, your model won’t be visible in-game. Make sure you pick the right materials too, as it may cause the model to be too dark or too bright.
    ...
    ![](/assets/images/models/smt-v-models/old%20incorrect%20materials.png)                                                                           
    *Incorrect base materials.*

    ![](/assets/images/models/smt-v-models/new%20correct%20materials.png)                                                                               
...
![](/assets/images/models/smt-v-models/scaling%20comp%20example.png)*Example of good and bad compendium scaling and positioning. You want to aim for the image on the right where the Persona takes up as much of the empty space.*
...
![](/assets/images/models/smt-v-models/model%20errors%20example.gif)                                                                       
