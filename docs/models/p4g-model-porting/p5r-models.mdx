...
![](/assets/images/models/p5r-models/gfd%20studio%20preview%201.png)

![](/assets/images/models/p5r-models/gfd%20studio%20preview%202%20anim.png)
...
![](/assets/images/models/p5r-models/gmd%20import%20script%20window.png)
...
![](/assets/images/models/p5r-models/base%20model%20viewport.png)

Move over to the left side and select the bone named "Root"

![](/assets/images/models/p5r-models/p5r%20root%20bone.png)

Next, move up to the top and right click the rotate option shown here:

![](/assets/images/models/p5r-models/p5r%20rotate%20selection.png)
...
![](/assets/images/models/p5r-models/correct%20model%20viewport%20rotation.png)

Now, let's export this base model. Move up to the top and select File > Export > Export

![](/assets/images/models/p5r-models/file%20export.png)
...
![](/assets/images/models/p5r-models/export%20options.png)
...
![](/assets/images/models/p5r-models/import%20script%20load%20animation.png)
...
![](/assets/images/models/p5r-models/play%20animation%20button%20location.png)
...
![](/assets/images/models/p5r-models/correctly%20rotated%20viewport.png)
...
![](/assets/images/models/p5r-models/smooth%20magic%20anim%20import%20script%20options.png)
...
![](/assets/images/models/p5r-models/configure%20frame%20end%20start%20option.png)

In the Start Time, set the value to a negative number above 100, like this:

![](/assets/images/models/p5r-models/frame%20start%20value%20shown.png)*You may need to set this number higher later on depending on the number of frames.*
...
![](/assets/images/models/p5r-models/shown%20negative%20frame%20keys.png)
...
![](/assets/images/models/p5r-models/shown%20merged%20frame%20keys.png)
...
![](/assets/images/models/p5r-models/final%20merged%20keyframes.png)
...
![](/assets/images/models/p5r-models/animation%20conversion%20bad%20and%20good.png)
...
![](/assets/images/models/p5r-models/old%20texture%20name%20location.png)*The default path contained in the GMS file will always point to where your GMD and GAP files are located, since the DDS files will have been extracted during the 3DS Max process.*
...
![](/assets/images/models/p5r-models/new%20texture%20name%20location.png)
...
![](/assets/images/models/p5r-models/missing%20texture%20warning.png)
...
![](/assets/images/models/p5r-models/surt%20material%20data.png)

Paste this copied data into your Persona's material data section as well:

![](/assets/images/models/p5r-models/old%20material%20data.png)

![](/assets/images/models/p5r-models/new%20material%20data.png)
...
![](/assets/images/models/smt-v-models/scaling%20comp%20example.png)
...
![](/assets/images/models/smt-v-models/pos%20battle%20example.jpg)
*Example of bad battle positioning, take note of the model clipping into the floor, you don't want that.*

![](/assets/images/models/smt-v-models/model%20errors%20example.gif)*Example of irregular model performance. This is typically caused by missing blend subsets.*
