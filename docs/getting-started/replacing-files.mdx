...
Now that you have [made a mod](./making-a-mod.mdx) you can start replacing the game's files. There are two broad types of files which you will replace in different ways: **loose** files and **packed** files.
...
![](/assets/images/getting-started/replacing-files/open-mod-folder.png)
...
![](/assets/images/getting-started/replacing-files/directory.png)
