...
Now that you have [made a mod](./making-a-mod.mdx) and [replaced some files](./replacing-files.mdx) with it, you'll want to share your creation with the world.
...
![](/assets/images/getting-started/publishing-a-mod/gb-add.png)
...
![](/assets/images/getting-started/publishing-a-mod/gb-private.png)
...
![](/assets/images/getting-started/publishing-a-mod/gb-id.png)
...
![](/assets/images/getting-started/publishing-a-mod/r2-update-support.png)
...
![](/assets/images/getting-started/publishing-a-mod/r2-publish.png)
...
![](/assets/images/getting-started/publishing-a-mod/export.png)
